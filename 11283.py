...
# first = [str(i.encode()) for i in first]
# second = [str(i.encode()) for i in second]
# third = [str(i.encode()) for i in third]
# print(first)

# ord함수를 통해 아스키 코드로 변환해서 시작을 1로 맞춰주기만 하면 된다
